...
//        static let baseURL = "http://ec2-34-215-84-223.us-west-2.compute.amazonaws.com:8081/teachus"  //v1`
    ...
    struct StudentURL {
        ...
        static let studentScheduleAttendance =      BaseUrl.baseURLV1 + "/student/schedule_attendance"


    }
    
    struct ParentsURL {
        static let getClassAttendance =             BaseUrl.baseURLV1 + "/parents/student_class_attendance"
        static let getAttendanceDetails =           BaseUrl.baseURLV1 + "/parents/student_attendance"
        static let updateRatings =                  BaseUrl.baseURLV1 + "/ratings/submit_rating"
        static let professorRatingList =            BaseUrl.baseURLV1 + "/ratings/professor_rating_list"
        ...
        static let getParentsNotesDetails =         BaseUrl.baseURLV1 + "/parents/notes_list_view"
        static let getParentsNotice =               BaseUrl.baseURLV1 + "/parents/notices"
    ...
    struct ProfessorURL {
        ...
        static let addSchedule  =                       BaseUrl.baseURLV1 + "/professor/add_schedule"
